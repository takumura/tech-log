...
`[link text]{.internal-link link=link_path}`
`.internal-link` is the css class to show internal link as a different style compare to external links.

```plaintext
Following link: [Move to Home]{.internal-link link=/docs/welcome} will move to initial home screen of this site
```

Following link: [Move to Home](docs/welcome){.internal-link} will move to initial home screen of this site

another internal link example: [Move to Old Examples](docs/example-old){.internal-link}

### Anchor Links

Anchor link will also working as same link syntax.

anchor link: [Move to Links](docs/example#links){.internal-link}

another anchor link example: [Move to Images](docs/example#images){.internal-link}

anchor link for another page: [Move to Old Examples - Links](docs/example-old#links){.internal-link}

Japaneses anchor is also available: [Move to Todo - 実施済み](docs/todo#実施済み){.internal-link}
